...
class ValueAtRiskMonteCarlo:
    ...
    def __init__(self, S, mu, sigma, c, n, iterations):
        # this is the value of the investment at t=0 (1000 dollars)
        self.S = S
        self.mu = mu
        self.sigma = sigma
        self.c = c
...
if __name__ == '__main__':
    ...
    S = 1e6 # this is the investment (stocks, etc)
    ...
    # we can assume daily returns to be normally distributed: mean and variance (std dev) can describe the process
