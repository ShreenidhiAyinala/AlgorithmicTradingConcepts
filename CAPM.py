...
RISK_FREE_RATE = 0.05
# consider monthly returns, calculate the annual return
MONTHS_IN_YEAR = 12
...
class CAPM:
    ...
    def regression(self):
        ...
        print("Beta from the formula: ", beta)
        # calculate the expected returns according to the CAPM formula
        # need annual return (this is why we multiply by 12)
